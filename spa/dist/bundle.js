...
},{"./collection":3,"./request":4,"./router":5,"./scroll":6,"./sections":7}],3:[function(require,module,exports){
'use strict';
...
var Collection = function () {
	function Collection(app) {
		...
		this.app.scroll.listen(this.section, this.app.request.shouldFetchCollection, this.section.getBoundingClientRect(), window.innerHeight / 2);
	}
	...
	_createClass(Collection, [{
		...
		value: function renderImage(data) {
			...
			var imagesToReplace = document.querySelectorAll('[data-guid="' + data.guid + '"]');
		...
		value: function closeMoreInformation() {
			// Select all open more information divs and close them
			var open = Array.from(document.querySelectorAll('.more-information'));
			open.forEach(function (openElement) {
...
},{"riot-route":10}],6:[function(require,module,exports){
'use strict';
...
var Scroll = function () {
	function Scroll() {
		...
		this.trigger = (0, _lodash.debounce)(this.trigger.bind(this), 250, {
